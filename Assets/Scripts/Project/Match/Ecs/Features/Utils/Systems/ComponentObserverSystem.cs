...
{
    public sealed class ComponentObserverSystem<TComponent> : IEcsInitSystem, IEcsRunSystem where TComponent : struct
    {
        ...
        public ComponentObserverSystem(IComponentObserver<TComponent> componentObserver)
        {
